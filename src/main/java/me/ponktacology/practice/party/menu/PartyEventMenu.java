              ...
              chosenLadder -> {
                ...
                if (party.size() < 2) {
                  Messenger.messageError(
                      player,
                      "You must have at least 2 players in your party in order to start a party event.");
                          ...
                          switch (event) {
                            case FFA:
                              ...
                              Practice.getService(MatchService.class)
                                  .start(chosenLadder, chosenArena, soloTeams);
                              break;
                            case SPLIT:
                              ...
                              Practice.getService(MatchService.class)
                                  .start(
                                      ...
                                      false,
                                      true,
                                      MultiTeam.of(playersA),
                                      MultiTeam.of(playersB));
                              break;
                          }
                        })
                    .openMenu(player);
