...
public class NameTags {
  ...
  public static void color(
      PracticePlayer observer, PracticePlayer observable, ChatColor color, boolean showHealth) {
    Player player = observer.getPlayer();
    Player other = observable.getPlayer();
    if (player == null || other == null || player.equals(other)) return;
